        ...
        <section class="case">
            ...
            <div class="flexbox">
                <section class="case-content">
                    ...
                    <a href="#" class="case-content__btn"><img class="border-none container mx-auto" src="<?php echo get_template_directory_uri(); ?>/assets/img/more.png" alt="詳細を見る"></a>
                </section>
            ...
            <p class="case-btn button-action"><a href="http://localhost/bluehouseHP/item/">施工実績一覧</a></p>
        </section>
