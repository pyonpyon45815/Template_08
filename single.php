...
<body>
    <div class="wrap">
        <!-- ヘッダー -->
        <div class=""  style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/img/danist-soh-dqXiw7nCb9Q-unsplash.jpg)">
    ...
    <h5 class="text-red-600 bg-green-500 text-5xl mt-5 text-center font-bold">これでどうでしょう？</h5>
